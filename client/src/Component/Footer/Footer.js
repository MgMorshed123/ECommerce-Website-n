      ...
      <div className="col-lg-4 col-md-6 footer-about">
        <div className="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
          <a href="index.html" className="navbar-brand">
            <h1 className="m-0 text-white"><i className="fa fa-user-tie me-2" />Shoopee</h1>
          </a>
        ...
        <div className="row gx-5">
          ...
          <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
            ...
            <div className="link-animated d-flex flex-column justify-content-start">
              ...
              < Link  className="text-light mb-2" to="/cart"><i className="bi bi-arrow-right text-primary me-2" />Cart</Link>
              <Link className="text-light" to="/categories"><i className="bi bi-arrow-right text-primary me-2" />Categories</Link>
            </div>
          </div>
          <div className="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
            <div className="section-title section-title-sm position-relative pb-3 mb-4">
